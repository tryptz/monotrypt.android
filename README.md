...
> A native Android hi-fi audio player built around a from-scratch **C++17 DSP engine**, a headphone **AutoEQ** driven by real measurement data, and **bit-perfect USB-DAC output** over a hand-written USB Audio Class driver.
